# ─────────────────────────────────────────────────────────────────────────────
# 04_era5_basemap.R — Basemap tile cache + shared globals (run this first)
#
# Purpose:
#   Render a static snapshot of the Mediterranean at the storm peak (22 Jan
#   2026, 15 UTC) AND — more importantly — cache the masked CartoDB raster
#   tile and compute the global death-counter normaliser used by both
#   animation scripts (05, 07). Without this step the animations have no
#   shared basemap or scaling reference.
#
# Inputs:
#   - data/united_cyclone_harry.csv
#   - data/era5/jan_atm_instant.nc
#
# Outputs:
#   - data/tiles/<provider>_masked.tif         (shared basemap)
#   - data/era5/_globals.rds                   (shared by scripts 05 and 07)
#   - output/figures/snapshot_2026-01-22_1500Z_mslp.png
#
# Usage:
#   Rscript scripts/04_era5_basemap.R peak
#
# Notes:
#   Run this once before either animation. The cached tile + globals.rds are
#   re-read from disk by 05_era5_animate.R and 07_msg_animate.R.
# ─────────────────────────────────────────────────────────────────────────────
