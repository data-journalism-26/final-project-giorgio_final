# ─────────────────────────────────────────────────────────────────────────────
# 07_msg_animate.R — Infrared satellite animation (MSG SEVIRI IR_108)
#
# Purpose:
#   Sibling of 05_era5_animate.R: same map / labels / shipwrecks, but the
#   raster layer is the MSG SEVIRI IR brightness temperature (10.8 µm
#   channel) instead of ERA5 wind + MSLP. Coldest cloud tops mark the
#   deepest convection inside the cyclone.
#
# Inputs:
#   - data/msg/ir108/*.nc                       (per-frame NetCDFs from 06)
...
#
# Outputs:
#   - output/frames_ir/frame_NNNN.png
#   - output/video/cyclone_harry_ir_full.mp4    (or _test.mp4)
#
# Usage:
#   Rscript scripts/07_msg_animate.R test       # ~9 frames around the storm peak
#   Rscript scripts/07_msg_animate.R full       # every frame in data/msg/ir108/
#
# Notes:
#   Run scripts/04_era5_basemap.R first (provides basemap + globals).
# ─────────────────────────────────────────────────────────────────────────────
